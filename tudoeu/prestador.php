		...
		<body style="background-color:#dee5fc;">
			<div class="box">
				...
				<table style = "height:100%; width:100%; border=0; border-collapse:collapse; background-color:#dee5fc;" >
					<tr>
						<td>
							<form action="prestador.php" method="POST" onsubmit="submitForm(event)">
								...
								<div style="padding-left:5px; text-align: center;">	
										...
										<div align="left" style="padding-left:15px">
											...
											<select name="cboservico" id="cboservico"  class="form-control" required>
												...
												<option value="desentupidor">Desentupidor(a)</option>
											...
											<div align="left">
												...
												<script>
													...
													function exibemensagem()
													{
														...
														if(campo2.value.substring(0, 2) != "87")
														{
																Swal.fire(
																{
																	icon: 'warning',
																	titleText: "No momento, o cadastro no aplicativo Tudo Eu está restrito para prestadores do DDD 87",
																	text: '',
																	showCloseButton: true
																}
																);																
