<?php
	if(isset($_POST['submit']))
	{
		...
		function send_whatsapp($destino,$servico,$cliente,$cidade){
			...
			"message_custom_id" : "0",
			"message_type" : "text",
			"message_body" : "👋Olá '.$cliente.' somos a Tudo Eu! Seu cadastro foi realizado com sucesso e em breve entraremos em contato com você para prestar o serviço de: '.$servico.' em: '.$cidade.'",
			"check_status" : "0"
			}',
