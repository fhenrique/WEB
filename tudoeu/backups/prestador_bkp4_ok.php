...
//		if(strlen($p_telefone) !== 11)
	//	{
		...
		if($result = mysqli_query($conexao,"INSERT INTO prestadores(data_cadastro, nome, telefone, servico, servico_outro, tipo_cobranca, valor, endereco, dias_disponiveis, horarios_disponiveis, tempo_experiencia, atende_cidade, obs) VALUES('$p_data','$p_nome','$p_telefone','$p_servico','$p_servicooutro', '$p_tipocobranca', '$p_valor', '$p_endereco','$p_dias','$p_horas','$p_tempoexperiencia','$p_cidadeatende','$p_obs')"))
		{
		
		function send_whatsapp($destino,$servico,$cliente,$cidade){
			$curl = curl_init();
			...
			"message_custom_id" : "0",
			"message_type" : "text",
			"message_body" : "👋Olá '.$cliente.' somos a Tudo Eu! Seu cadastro foi realizado com sucesso e em breve entraremos em contato com você para prestar seu serviço na(s) cidade(s) de: '.$cidade.'",
			"check_status" : "0"
			}',
		...
		send_whatsapp($p_telefone,$p_servico,$p_nome,$p_cidadeatende);			
		...
		<body style="background-color:#dee5fc;">
			<div class="box">
				<table style = "width:100%; border=0; border-collapse:collapse; background-color:#07183f;" >
					...
					<tr align= "center">
						<td style="font size='25'">
							<strong style="font-size: 25px; color:#e84026; font-family:verdana;">Tudo Eu! Ambiente de teste</strong>
						</td>
					</tr>
				</table>
				...
				<table style = "height:100%; width:100%; border=0; border-collapse:collapse; background-color:#dee5fc;" >
					<tr>
						<td>
							<form action="teste.php" method="POST" onsubmit="submitForm(event)">
								...
								<div style="padding-left:5px; text-align: center;">	
										...
										<div align="left" style="padding-left:15px">
											...
											<select name="cboservico" id="cboservico"  class="form-control" required>
												...
												<option value="bateria">Outros</option>
											</select>										
										</div>
										<div align="left" style="padding-left:15px">
											...
											<br>
											<div id="dvoutro">
												<strong "style="font-size: 15px; font-family:verdana">Outro serviço</strong>
												<input name="txtoutro" id="txtoutro" type="Text" class="form-control" placeholder="Outros no campo acima e seu serviço aqui" >
											</div>											
											...
											<select name="cboTipoCobranca" id="cboTipoCobranca" class="form-control" style="max-width:50%;" required>
												...
												<option value="porempreitada">Por corrida</option>
											</select>
											...
											<div align="left">
												...
												<script>
													...
													function exibemensagem()
													{
														...
														if(campo2.value.length != 11)
														{
																var tamanho = campo2.value.length
								...
								<table align="center">
									...
									<div align="left">
										<strong "style="font-size: 10px; font-family:verdana">* Pagamentos serão realizados via PIX pela Tudo Eu, após a confirmação da conclusão do(s) serviço(s) prestado(s).</strong>
										<br>
										<br>								
										<br>
										<br>										
