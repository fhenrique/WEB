<?php
	if(isset($_POST['submit']))
	{
		...
		if($result = mysqli_query($conexao,"INSERT INTO dados(srv_tipo, srv_data, srv_hora, srv_endereco, srv_obs, cli_nome, cli_telefone, cli_obs, notificado) VALUES('$serv_tipo','$serv_data','$serv_hora', '$serv_endereco', '$serv_obs', '$cl_nome','$cl_telefone','$cl_obs','$cl_notificado')"))
		{
			sleep(6);
			//echo "Inseriu";
											...
											<tr align="center">
												<td>
													...
													<script>
														...
														var campo2 = document.getElementById("txtdata");
														var campo3 = document.getElementById("txthora");
														var campo4 = document.getElementById("txtendereco");
														var campo5 = document.getElementById("txtclientenome");
														var campo6 = document.getElementById("txtclientetelefone");
														...
														function exibemensagem()
														{
															...
															if(campo2.value == "" || campo3.value == "" || campo4.value == "" || campo5.value == "" || campo6.value == "") {
																return;
															}			
