...
class ListaEmpresas{
    ...
    public function setLista($limite=null)
    {
        ...
        if($limite == null)
        {
            $busca = $this->c->query("SELECT * FROM empresas");
        }else
        {
            $busca = $this->c->query("SELECT * FROM empresas LIMIT 0,".$limite);
        }
    ...
    public function setListaBySegmento($seg,$limite=null)
    {
        ...
        if($limite == null)
        {
            $busca = $this->c->query("SELECT * FROM empresas WHERE id_segmento = $seg");
        }else
        {
            $busca = $this->c->query("SELECT * FROM empresas WHERE id_segmento = $seg LIMIT 0,".$limite);
        }
