...
<body id="main">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-8 mx-auto">
                        <div class="detail-box" >
                            ...
                            <p>
                                Aqui quem define a classificação das empresas são os clientes!
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="job_section layout_padding" id="container-empresas">
        <div class="container">
            ...
            <div class="job_container">
                <h4 class="job_heading">
                    Baseado na Satisfação e votação dos Clientes e Consumidores
                </h4>
                <br>
        ...
        $paginas = intval(ceil($qtd_empresas / $limite));
        ...
        ?>
          ...
          for($emp = $i; $emp <= $i+1; $emp++){
            if(isset($empresas[$emp])){
                $contador_empresas++;
          ?>
                    <?php if($contador_empresas > 10): ?>
                    <div class="col-lg-6 box-empresa hidden-item" data-page="<?= ceil($contador_empresas/$limite);?>">
                    <?php else: ?>    
                    <div class="col-lg-6 box-empresa" data-page="<?= ceil($contador_empresas/$limite);?>">
                    <?php endif; ?>
                        <div class="box">
    ...
    <section class="expert_section layout_padding" id="container-top">
        ...
        ?>
              ...
              if(file_exists($empresas[$j]->getImagem())){
                ...
                $caminhoTop = "images/job_logo1.png";
              }
              ?>
