        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <div class="page-title">
                    ...
                    <p class="text-subtitle text-muted">Área para adição e edição de segmentos e empresas.</p>
                </div>
                    ...
                    <div class="row match-height">
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="validar_segmento.php">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="validar_empresa.php" method="post">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
